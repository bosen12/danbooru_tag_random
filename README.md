...
**「活動」tag 看尺度決定要不要進。** 只有尺度勾了「活動」時，`playing sports`／`tennis`／`badminton` 這類動作 tag 才會進必進 POS。誘惑、走光、性愛（含混合）要的是球衣和球場，不是「正在打球」這個動作——而且抽牌規則規定會動的活動跟性愛動作不能並存，帶著它會讓性愛整個抽不到。游泳是例外，`swimming` 本來就在白名單裡，所以一直都帶著。
